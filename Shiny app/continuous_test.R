  ...
  fluidRow(
    column(
      ...
      sidebarLayout(
        ...
        sidebarPanel(
          sliderInput("solar_electricity", "Solar:", min = 0, max = 20, value = 10),
          sliderInput("wind_electricity", "Wind:", min = 0, max = 10, value = 5),
          sliderInput("bio_electricity", "Biomass", min = 0, max = 3, value = 1.5),
